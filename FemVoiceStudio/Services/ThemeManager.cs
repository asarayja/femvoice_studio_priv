...
{
    // NOTE (Linux portable-core split, 2026-06-16): AppTheme / AppSettings / DebugSettings /
    // AppSettingsJson were moved to FemVoice.Core/Services/SettingsModels.cs so the settings +
    // localization family can build on Linux. They keep namespace FemVoiceStudio.Services and are
    // consumed here via the FemVoice.Core project reference — behaviour is unchanged.
