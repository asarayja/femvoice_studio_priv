...
## Linux (x64) — `femvoice-studio_0.1.6_amd64.deb`
Debian/Ubuntu-pakke. Installer:
```
sudo apt install ./femvoice-studio_0.1.6_amd64.deb
```
...
## Arch Linux (x86_64) — `femvoice-studio-0.1.6-1-x86_64.pkg.tar.zst`
Ferdig pacman-pakke. Installer:
```
sudo pacman -U femvoice-studio-0.1.6-1-x86_64.pkg.tar.zst
```
