...
public partial class ClinicianPanelView : UserControl
{
    public ClinicianPanelView() => AvaloniaXamlLoader.Load(this);
    ...
    {
        if (DataContext is ClinicianPanelViewModel vm)
            await ProfessionalReportExport.SaveAsync(this, vm.Report, format, "utfallssammendrag", ShowStatus);
    }
