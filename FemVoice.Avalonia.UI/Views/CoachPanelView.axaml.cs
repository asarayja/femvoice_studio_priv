...
public partial class CoachPanelView : UserControl
{
    public CoachPanelView() => AvaloniaXamlLoader.Load(this);
    ...
    {
        if (DataContext is CoachPanelViewModel vm)
            await ProfessionalReportExport.SaveAsync(this, vm.Report, format, "veiledersammendrag", ShowStatus);
    }
